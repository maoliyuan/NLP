...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--test_interval', type=int, default=20, help='training epoch number before testing once')
    #### Training Hyperparams ####
    arg_parser.add_argument('--batch_size', default=32, type=int, help='Batch size')
    arg_parser.add_argument('--lr', type=float, default=5e-6, help='learning rate') # 1e-3 if not using transformer
    ...
    arg_parser.add_argument('--transformer', default=False, action='store_true', help='use transformer')
    ...
    arg_parser.add_argument('--BI_embedding_dim', default=20, help='dimension of BI indicator')
    return arg_parser